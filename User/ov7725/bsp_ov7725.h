...
#define FIFO_CS_L()     GPIOA->BRR  =GPIO_Pin_3	  /*拉低使FIFO输出使能*/
...
#define FIFO_RRST_H()   GPIOA->BSRR =GPIO_Pin_2	  /*拉高允许FIFO读(数据从FIFO输出)指针运动 */
#define FIFO_RRST_L()   GPIOA->BRR  =GPIO_Pin_2	  /*拉低使FIFO读(数据从FIFO输出)指针复位 */

#define FIFO_RCLK_H()   GPIOC->BSRR =GPIO_Pin_5	  
#define FIFO_RCLK_L()   GPIOC->BRR  =GPIO_Pin_5	  /*FIFO输出数据时钟*/
